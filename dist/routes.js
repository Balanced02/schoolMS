...
//Queries
api.get('/getOtnote', _api.GetOtNotes);
...
api.get('/getAcademicDetails', _api.GetAcademicDetails);
...
api.post('/newAcademicYear', _api.AcademicDetailsUpdate);
api.post('/updateUserModule', _api.UpdateUserModule);
